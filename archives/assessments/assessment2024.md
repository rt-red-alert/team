...
### 2. 注意事项
   （1）    考试过程中，考生以及考官不得消极考试，不得无故中断考试。
   （2）    每张考试图考生可以申请至多两次的重打机会，考官有权拒绝。
   （3）    考试中允许除利用游戏BUG、作弊、嘲讽和人身攻击以外的一切操作。
   （4）    建议考官和考生不局限于一个阵营，尽可能全面展示自己的技术。
   （5）    考官自选的两张地图应当包括一张发展图和一张较小的刺刀图。
   （6）    同一场考试允许多名考官参与，共同评定考核结果。
   （7）    考官给出的军衔不得高于考官自身的军衔。
   （8）    考官可以对考核过程录像，但上传视频至网络平台需要经过考生同意。
### 3. 考核类型
